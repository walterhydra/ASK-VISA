    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        @media (max-width: 768px) {
            ...
            .headline-carousel { height: 4.5em; line-height: 1.3em; }
            .carousel-track > div { 
                height: 4.5em; 
                white-space: normal; 
                padding: 0 10px; 
        ...
        @media (max-width: 768px) {
            html { scroll-padding-top: 100px; } /* Anchor scroll fix for sticky header */
            nav { 
                width: calc(100% - 32px); 
                padding: 0 16px; 
                height: 64px; 
            ...
            /* Minimize hero blank space on mobile */
            .hero { padding: 120px 16px 40px; }
            .hero h1 { font-size: 1.85rem; margin-bottom: 12px; }
            .hero-subhead { font-size: 1.05rem; margin-bottom: 28px; padding: 0 8px; }
            ...
            .search-container { flex-direction: column; border-radius: 24px; padding: 12px; gap: 12px; }
            .search-container select { padding: 10px 0; font-size: 1rem; text-align: center; }
            .search-btn { width: 100%; justify-content: center; padding: 16px; }

            /* Cards */
            .cards-grid { gap: 24px; }
            .card-content { padding: 20px; }
            .visa-info { font-size: 0.85rem; margin-bottom: 16px; }
            ...
            .stamp-wrapper { 
                flex: 0 0 auto; 
                order: -1; /* Move stamp to top on mobile */
                margin: 0 auto;
            }
            .stamp { 
                width: 120px; 
            ...
            .modal-content { 
                ...
                overflow-y: visible; 
                margin: 0 auto;
                display: block; /* Ensure natural scrolling */
            }
            .modal-body { 
                padding: 24px 20px; 
            }
...
<body>
    ...
    <section class="hero">
        <h1 class="animate-up" style="animation-delay: 0.1s;">
            <div class="headline-carousel">
                <div class="carousel-track">
                    <div>World travel: <span class="highlight" style="margin-left: 8px;">Made simple.</span></div>
                    <div>Navigating visas: <span class="highlight" style="margin-left: 8px;">Made easy.</span></div>
                    <div>We speak visa: <span class="highlight" style="margin-left: 8px;">You travel.</span></div>
                    <div>World travel: <span class="highlight" style="margin-left: 8px;">Made simple.</span></div>
                </div>
            </div>
        </h1>
        <p class="hero-subhead animate-up" style="animation-delay: 0.2s;">
            Premium e-visa processing for global destinations.
        </p>
        ...
        <div class="trust-strip animate-up" style="animation-delay: 0.4s;">
            ...
            <div class="trust-item"><i class="fas fa-circle-check"></i> Hassle-free process</div>
