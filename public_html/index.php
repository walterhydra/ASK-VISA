...
if (isset($_GET['ajax'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        $doc_type = $field_key;
        if ($field_key === 'passport_front')
            $doc_type = 'passportfront';
        if ($field_key === 'passport_back')
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .select-container { display: flex; flex-direction: column; gap: 8px; width: calc(100% - 46px); max-width: 420px; margin-top: 10px; box-sizing: border-box; transition: var(--transition); }
        ...
        .select-container.scrollable-options::-webkit-scrollbar { width: 6px; }
        .select-container.scrollable-options::-webkit-scrollbar-track { background: transparent; }
        .select-container.scrollable-options::-webkit-scrollbar-thumb { background: var(--border); border-radius: 10px; }
        .select-container.scrollable-options::-webkit-scrollbar-thumb:hover { background: var(--primary); }
        ...
        .option-name { flex: 1; line-height: 1.3; word-break: break-word; overflow-wrap: break-word; hyphens: auto; }
        .option-price { white-space: nowrap; font-weight: 800; text-align: right; flex-shrink: 0; }
        ...
        .select-search-input::placeholder { color: var(--text-muted); }
        .select-search-icon { color: var(--text-muted); font-size: 0.9rem; }
        ...
        @media (max-width: 768px) {
            .chat-header { padding: 10px 16px; min-height: 60px; }
...
<div class="app-container">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-actions">
            ...
            <button class="sidebar-btn" onclick="window.location.href='track_application.php'"><i class="fas fa-search-location"></i> Track My Application</button>
